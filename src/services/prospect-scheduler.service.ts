 ...
 * Post-demo automation — single objective: paid activation or clean, explicit exit.
 *
 ...
 * - Day 1+2h: PD_SMS_STAKEHOLDER_FOLLOWUP — SMS after stakeholder email
...
const POST_DEMO_SEQUENCE: SequenceStep[] = [
  ...
  { messageType: 'PD_SMS_STAKEHOLDER_FOLLOWUP', delayMs: 24 * HOUR + 2 * HOUR }, // 2h after stakeholder email
